        ...
        get dialog() {
            ...
            (function (e) {
                for (; e && e !== document.body;) {
                    var t = window.getComputedStyle(e), o = function (e, o) {
    ...
    if (r.reposition = function (e) {
            ...
            for (var t = 0; t < document.styleSheets.length; ++t) {
                ...
                if (n)for (var a = 0; a < n.length; ++a) {
                    ...
                    if (l && i(l, e)) {
                        var s = r.style.getPropertyValue("top"), d = r.style.getPropertyValue("bottom");
            ...
            this.overlay = document.createElement("div"), this.overlay.className = "_dialog_overlay", this.overlay.addEventListener("click", function (t) {
                ...
                t.forEach(function (e) {
                    for (var t,
                             i = 0; t = e.removedNodes[i]; ++i)t instanceof Element && ("dialog" === t.localName && o.push(t), o = o.concat(t.querySelectorAll("dialog")))
                }), o.length && e(o)
            }))
            ...
            for (var e, t = this.zIndexHigh_,
                     o = 0; e = this.pendingDialogStack[o]; ++o)e.updateZIndex(--t, --t), 0 === o && (this.overlay.style.zIndex = --t);
            ...
            if (this.forwardTab_ = void 0, 27 === t.keyCode) {
                ...
                var o = new e("cancel", {bubbles: !1, cancelable: !0}), i = this.pendingDialogStack[0];
        ...
        HTMLFormElement.prototype.submit = function () {
            ...
            if (n(o)) {
                ...
                if (i) {
                    ...
                    a && a.form === o ? i.close(r.useValue || a.value) : i.close(), r.formSubmitter = null
                }
            }
        }, !0)
    }
    r.forceRegisterDialog = r.forceRegisterDialog, r.registerDialog = r.registerDialog, "function" == typeof define && "amd" in define ? define(function () {
        return r
    }) : "object" == typeof module && "object" == typeof module.exports ? module.exports = r : window.dialogPolyfill = r
}();
